...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("MrBot1000 v2.0.20f")
    ...
    def create_ui(self):
        ...
        title_lbl = QLabel("MrBot1000 v2.0.20f")
        ...
        # tab is opened, so you don't have to click Refresh manually (v2.0.20f).
    ...
    def _on_tab_changed(self, index: int):
        # Auto-populate the Ollama model dropdowns the first time the Settings
        # tab is shown (v2.0.20f). Avoids requiring a manual Refresh click and
